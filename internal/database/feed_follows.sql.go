...
INSERT INTO feedFollow (feed_id, user_id) VALUES ($1, $2) RETURNING id, created_at, updated_at, feed_id, user_id
`
...
SELECT id, created_at, updated_at, feed_id, user_id FROM feedFollow WHERE user_id = $1
`
