...
const updateFeedLastFetched = `-- name: UpdateFeedLastFetched :one
...
func (q *Queries) UpdateFeedLastFetched(ctx context.Context, id uuid.UUID) (Feed, error) {
	row := q.db.QueryRowContext(ctx, updateFeedLastFetched, id)
	var i Feed
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
